    ...
    return (
        <div className="flex flex-col py-3 ">
            <div className="flex flex-col pb-1 ">
                <h1 className="text-2xl py-0.5">AGH Univeristy of science and technology — Master degree </h1>
                <h3 className="text-blue-1 py-0.5 text-sm">2021-2022</h3>
                <h2 className="text-major-1 py-0.5 text-xl"> Master of Science in Geodesy, Surveying and Cartography</h2>
            ...
            <div className="flex flex-col pb-1 ">
                <h1 className="text-2xl py-0.5">AGH Univeristy of science and technology  — Engineer's degree</h1>
                <h3 className="text-blue-1 py-0.5 text-sm">2017-2021</h3>
                <h2 className="text-major-1 py-0.5 text-xl"> Engeneer of Geodesy, Surveying and Cartography </h2>
