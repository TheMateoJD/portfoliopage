export default function Hero(){
    return (
        <div className=" w-67.5 pt-8 pb-3">
            ...
            <span className="text-8xl font-normal bg-[linear-gradient(225deg,#00FF00,#590BF6)] text-transparent bg-clip-text">Mateusz Surmański</span>
            ...
            <div className="text-minor-1  transition duration-300  hover:text-major-1  ">
                <a href="#contact" className=" flex flex-row items-center gap-1 w-20">
