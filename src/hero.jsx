...
export default function Hero({setNavhome,modal,setModal}) {
    ...
    return (
        <header className="
         4k:w-100 1440p:w-80 xl:w-67.5 lg:w-60 md:w-45 sm:w-37 w-20
          pt-3 pb-3">
            <p ref={myRef} className="text-base text-minor-1 pb-1.25 font-semibold">Hey, I'm</p>
            <span  className=" 4k:text-big-2 1440p:text-big-1  lg:text-8xl md:text-7xl sm:text-5xl text-5xl font-normal bg-[linear-gradient(225deg,#00FF00,#590BF6)] text-transparent bg-clip-text">Mateusz Surmański</span>
